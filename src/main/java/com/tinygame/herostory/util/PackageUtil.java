...
public final class PackageUtil {
     ...
     * @return 符合条件的类集合
     */
    public static Set<Class<?>> listClazzFromDir(File dirFile, String packageName, boolean recursive, IClazzFilter filter) {
        ...
        while (!fileQ.isEmpty()) {
            ...
            try {
                //加载类定义
                Class<?> classObj = Class.forName(clazzName);
